                ...
                <div className="landing-footer-parent">
                    <div className="landing-footer-childl">
                        <div className="landing-footer-childl-heading">
                            <p><span className="ted">TED<sup>x</sup></span><span className="iitr">IITRoorkee</span></p>
                        </div>
...
This year, TEDxIITRoorkee is focused on encouraging people to go against the flow and try out new ventures, and also guide them along their journey.
</p>
                        </div>
                    </div>
